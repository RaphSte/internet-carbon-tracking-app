package de.htwg.internetCarbonTtrackingApp;
...
import de.htwg.internetCarbonTtrackingApp.ui.vpn.CarbonTrackingVpnService;

public class CarbonTrackingVpnClient extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.connect).setOnClickListener(v -> {
            ...
            prefs.edit()
                    ...
                    .commit();
            Intent intent = VpnService.prepare(CarbonTrackingVpnClient.this);
            if (intent != null) {
        ...
        findViewById(R.id.disconnect).setOnClickListener(v -> {
            startService(getServiceIntent().setAction(CarbonTrackingVpnService.ACTION_DISCONNECT));
        });
    }
    ...
    protected void onActivityResult(int request, int result, Intent data) {
        if (result == RESULT_OK) {
            startService(getServiceIntent().setAction(CarbonTrackingVpnService.ACTION_CONNECT));
        }
    }
    private Intent getServiceIntent() {
        return new Intent(this, CarbonTrackingVpnService.class);
    }
