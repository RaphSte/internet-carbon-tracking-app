...
public class CarbonTrackingVpnConnection implements Runnable {
    ...
    public CarbonTrackingVpnConnection(final VpnService service, final int connectionId,
    ...
    private final String getTag() {
        return CarbonTrackingVpnConnection.class.getSimpleName() + "[" + mConnectionId + "]";
    }
